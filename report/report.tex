...
polishing the language of this report. We explicitly confirm that the
\textbf{core methodological choices, coding decisions, results
generation, and interpretation of findings are our own work}, and the
group remains fully responsible for correctness and academic integrity.
...
weights produced by the year-$Y$ optimisation. Source file:
...
\emph{How constructed:} extracted from
\texttt{outputs\_part1/part1\_allocation\_diagnostics.csv} and
\texttt{outputs\_part2/part2\_allocation\_diagnostics.csv}, which are
produced as a side-effect of the annual optimisation loop in
\texttt{portfolio\_part2.py}.
